    ...
    >
      ...
      <div className="anim-pop relative flex flex-col items-center gap-5">
        <div className="relative">
          ...
          />
          <img src={brand.flame} alt="" aria-hidden className="anim-flame relative h-36 w-36 object-contain" />
        </div>
        <h1 className="font-display text-4xl text-white">{t.mcTitle}</h1>
        <p className="text-[var(--color-ink-2)]">{t.missionDoneSub}</p>
        <div className="flex items-baseline gap-2">
          <span className="ltr tabular font-display text-6xl text-[var(--color-orange)]">{streak}</span>
